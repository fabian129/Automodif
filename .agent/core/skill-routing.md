...
→ 07 Copywriter → 18 Text Harmonizer → 08 Performance Guardian → 09 Style Propagator
...
### Text Harmonizer
- **Runs AFTER Copywriter and Layout** — text must exist to be harmonized
- **Focuses on RHYTHM and MICRO-TYPOGRAPHY** — not just font choice
- **Reads `active-dna.md`** but extends it with optical sizing rules
- **Output:** Global CSS variables for spacing, line-height, and responsive scaling
...
| Humanizing typography (spacing, rhythm, optical sizing) | 18 Text Harmonizer |
